...
class English : Language() {
    private val messages = mapOf(
        "welcomeIntro" to "${GREEN.ON}Welcome to the Privilege Game!${GREEN.OFF} This game is designed to shed light on societal inequalities and the uneven distribution of opportunities. Our goal is to foster empathy towards social minorities, encourage self-reflection on your societal position, and stimulate a stance of solidarity. Let's challenge our understanding and dive into the complex dynamics of privilege. Triggerwarning: Topics such as sexual violence or racism will be mentioned. ${BLUE.ON}Hit Enter${BLUE.OFF}.",
...
class Arabisch : Language() {
        private val messages = mapOf(
            "welcomeIntro" to "${GREEN.ON}مرحبًا بك في لعبة الامتياز!${GREEN.OFF} هذه اللعبة مصممة للتأكيد على عدم المساواة في المجتمع وتوزيع الفرص بشكل غير متساوي. هدفنا هو تعزيز التعاطف مع الأقليات الاجتماعية، وتشجيع الانعكاس الذاتي على موقعك في المجتمع، وتحفيز موقف التضامن. دعونا نتحدى فهمنا ونغوص في ديناميكية الامتياز المعقدة. تحذير: سيتم ذكر موضوعات مثل العنف الجنسي أو العنصرية. ${BLUE.ON}اضغط Enter${BLUE.OFF}.",
