val fragenFaktenEng = listOf(
    ...
    Pair(
        ...
        "Fakt: Laut einer 20-jährigen Studie erhöhen Eltern, die Bücher im Haus haben, unabhängig von ihrem eigenen Bildungsstand das Bildungsniveau, das ihre Kinder erreichen werden, wobei sogar eine kleine Bibliothek von 20 Büchern einen signifikanten Einfluss hat. - ScienceDaily"
    ),
    Pair(
    ...
    Pair(
        ...
        "Fakt: Laut der Internationalen Fernmeldeunion (ITU) hatten bis Ende 2019 etwa 46% der Weltbevölkerung keinen Zugang zum Internet und somit leichten Zugang zu Bildung, Informationen und Kommunikation."
    ),
    Pair(
    ...
    Pair(
        ...
        "Fakt: Laut einer Umfrage von Gallup aus dem Jahr 2013 lieben weltweit nur 13% der Menschen ihren Job. In Deutschland sind es 15%."
    ),
    Pair(
        "Kannst du mindestens alle drei Monate neue Kleidung kaufen?",
        "Fakt: Laut einer Studie von Greenpeace aus dem Jahr 2017 kaufen die Deutschen im Durchschnitt 60 neue Kleidungsstücke pro Jahr. Das sind 5 neue Kleidungsstücke pro Monat."
    ),
    Pair(
        "Hast du ein interessantes Leben und blickst zuversichtlich in die Zukunft?",
        "Fakt: Laut einer Studie von Our World in Data variiert die Lebenszufriedenheit und das Glück weltweit stark. Reiche Menschen neigen dazu zu sagen, dass sie glücklicher sind als arme Menschen; reiche Länder neigen dazu, höhere durchschnittliche Glückslevel zu haben; und im Laufe der Zeit haben die meisten Länder, die anhaltendes Wirtschaftswachstum erlebt haben, steigende Glückslevel gesehen."
    ),
    Pair(
        "Kannst du leicht mit öffentlichen Verkehrsmitteln in die nächste Stadt kommen?",
        "Fakt: In Deutschland haben laut einer Studie des Bundesministeriums für Verkehr und digitale Infrastruktur 23% der Bevölkerung keinen Zugang zu einem hochwertigen öffentlichen Verkehrsangebot."
    ),
    Pair(
        "Schläfst du nachts in einem Bett?",
        "Fakt: Laut einer Studie der Bertelsmann Stiftung aus dem Jahr 2019 sind in Deutschland etwa 678.000 Menschen obdachlos. Das sind 0,8% der Bevölkerung. Weltweit sind etwa 1,6 Milliarden Menschen von Wohnungslosigkeit betroffen. Das sind 22% der Weltbevölkerung."
    ),
    Pair(
        "Wenn du dich zu politischen oder sozialen Themen äußerst, hast du das Gefühl, dass deine Meinung wert geschätzt wird?",
        ".."
    ),
    Pair(
        "Kannst du eine zahnärztliche Behandlung bekommen wann immer du möchtest?",
        "Fakt: Die Weltgesundheitsorganisation berichtet, dass weltweit etwa 3,5 Milliarden Menschen keinen Zugang zu grundlegenden oralen Gesundheitsdiensten haben."
    ),
    Pair(
        "Kannst du deine Partnerin oder deinen Partner auf der Straße küssen, ohne Angst vor Anfeindungen zu haben?",
        "Fakt: Human Rights Watch berichtet, dass in vielen Teilen der Welt, insbesondere in Ländern mit strengen Anti-LGBT-Gesetzen, Menschen Angst vor öffentlichen Demonstrationen von Zuneigung haben können, insbesondere wenn sie Teil der LGBT-Gemeinschaft sind."
    ),
    Pair(
        "Hast du keine Angst vor einer Abschiebung?",
        "Fakt: Laut UNHCR waren Ende 2020 fast 82,4 Millionen Menschen weltweit auf der Flucht vor Konflikten und Verfolgung, darunter fast 13 Millionen Kinder. Viele dieser Menschen leben in ständiger Angst vor Abschiebung."
    ),
    Pair(
    ...
    Pair(
        ...
        "Fakt: Laut Pew Research Center haben 58% der US-Erwachsenen großes Vertrauen in die Polizei, aber nur 33% der schwarzen Erwachsenen teilen dieses Vertrauen."
    ),
    Pair(
